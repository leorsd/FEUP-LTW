...
$type = $_GET['type'] ?? 'created'; // 'created', 'bought', or 'sold'
...
switch ($type) {
    case 'bought':
        $result = $service->getServices('bought', $user_id, $filters, $orderby, $page, $per_page);
        break;
    case 'sold':
        $result = $service->getServices('sold', $user_id, $filters, $orderby, $page, $per_page);
        break;
    default:
        $result = $service->getServices('created', $user_id, $filters, $orderby, $page, $per_page);
        break;
}
